...
1) Toplanan Bilgiler
- Cihaz ve kullanim verileri: uygulama ici etkilesimler, ekranlar, performans
  verileri (Firebase Analytics).
- Hata/cokme raporlari: teknik hata ve performans verileri (Firebase
  Crashlytics).
- Tanimlayicilar: uygulama instance ID, reklam kimligi gibi cihaz
